...
export default function OrchestratorPage() {
  ...
  const bookSchedule = async (option: ScheduleOption) => {
    ...
    try {
      for (const appt of option.appointments) {
        ...
        await fetch('https://smartvisit-fhir.duckdns.org/fhir/Appointment', {
          method: 'POST',
 ...
 if (status === "loading") {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-stone-50 to-gray-100 p-4 sm:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto">
              <div className="flex justify-between items-start mb-6">
                  <div className="flex-1">
                      <h1 className="text-4xl sm:text-5xl font-bold mb-3 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                          SmartVisit Scheduler
                      </h1>
             ...
             {/* FHIR Interoperability Banner */}
<div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 text-white p-5 sm:p-6 rounded-xl shadow-xl mb-6 border border-indigo-400">
      ...
      <div className="flex-1">
        <div className="flex items-center space-x-3 mb-2">
          <h3 className="font-bold text-xl sm:text-2xl">
            FHIR-Compliant Scheduling Platform
          </h3>
          <span className="bg-yellow-400 text-yellow-900 px-3 py-1 rounded-full text-xs font-bold">
            DEMO
          </span>
        </div>
        <p className="text-sm sm:text-base text-indigo-100 mb-3">
          Built on HL7 FHIR R4 standards • Designed to integrate with FHIR-enabled EMR systems through standard configuration
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
          <div className="bg-white bg-opacity-95 p-3 rounded-lg border border-indigo-300">
            <p className="text-xs text-gray-700">
              Queries FHIR <code className="bg-indigo-100 px-1 rounded text-indigo-900 font-semibold">Patient</code> resources with demographics and insurance coverage
            </p>
          </div>
          <div className="bg-white bg-opacity-95 p-3 rounded-lg border border-indigo-300">
            <p className="text-xs text-gray-700">
              Fetches availability from FHIR <code className="bg-indigo-100 px-1 rounded text-indigo-900 font-semibold">Schedule/Slot</code> resources with service types and practitioners
            </p>
          </div>
          <div className="bg-white bg-opacity-95 p-3 rounded-lg border border-indigo-300">
            <p className="text-xs text-gray-700">
              Creates FHIR <code className="bg-indigo-100 px-1 rounded text-indigo-900 font-semibold">Appointment</code> resources linked to patients, practitioners, and time slots
            </p>
          </div>
        </div>
      </div>
...
<div className="bg-white rounded-xl shadow-lg p-6 mb-6 border border-gray-200">
  <h2 className="text-xl font-semibold mb-2 text-gray-900">Select Patient</h2>
  <div className="mb-4 p-3 bg-amber-50 border-l-4 border-amber-400 rounded-lg">
    <p className="text-sm text-amber-800">
      <span className="font-semibold">💡 Demo Mode:</span> Using synthetic patient data. In production, patient data is pulled from your EMR via FHIR Patient resources.
    </p>
  </div>
  <select
...
<div className="bg-white rounded-xl shadow-lg p-6 mb-6 border border-gray-200">
  ...
  <div className="mb-4 p-3 bg-purple-50 border-l-4 border-purple-400 rounded-lg">
    <p className="text-sm text-purple-800">
      <span className="font-semibold">🏥 Available Departments:</span> Each specialty has unique services and practitioners. FHIR-compliant for any EMR configuration.
    </p>
  </div>
...
{selectedSpecialty && (
  <div className="bg-white rounded-xl shadow-lg p-6 mb-6 border border-gray-200">
    ...
    {/* Technical Integration Info Footer */}
    <div className="mt-8 bg-white rounded-xl shadow-lg p-6 border border-gray-200">
      <div className="flex items-center space-x-3 mb-4">
        <span className="text-2xl">⚡</span>
        <h3 className="text-xl font-bold text-gray-900">
          Enterprise FHIR Integration Architecture
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        <div className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-2xl">📊</span>
            <p className="font-bold text-blue-900">Patient Data</p>
          </div>
          <p className="text-sm text-blue-800">
            Queries FHIR <code className="bg-white px-1 rounded">Patient</code> resources with demographics and insurance coverage
          </p>
        </div>
        ...
        <div className="p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-2xl">📅</span>
            <p className="font-bold text-green-900">Real-Time Slots</p>
          </div>
          <p className="text-sm text-green-800">
            Fetches availability from FHIR <code className="bg-white px-1 rounded">Schedule/Slot</code> resources with service types and practitioners
          </p>
        </div>
        ...
        <div className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-2xl">🔒</span>
            <p className="font-bold text-purple-900">Secure & Compliant</p>
          </div>
          <p className="text-sm text-purple-800">
            SMART on FHIR authentication with OAuth 2.0 for secure EMR integration
          </p>
        </div>
      </div>
     <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-300">
        <p className="text-sm text-gray-700 mb-2">
          <span className="font-semibold">🏗️ Production Deployment:</span> Requires FHIR endpoint configuration, OAuth credentials, and EMR-specific resource mapping.
        </p>
        <p className="text-xs text-gray-600 italic">
          Compatible with Epic, Oscar, Cerner, Allscripts, and other FHIR R4-compliant EMR systems through standard configuration.
        </p>
      </div>
    </div>
    </div>
